 ...
 * @author slix0
 */
public class View_Rep_HistoriaClinica extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_Rep_HistoriaClinica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new View_Rep_HistoriaClinica().setVisible(true);
            }
        });
    }
